        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="flex space-x-4">
              {/* Социальные сети */}
              <a href="#" className="w-10 h-10 bg-gray-700 hover:bg-medical-blue rounded-lg flex items-center justify-center transition-colors duration-300">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <p className="text-gray-300">info@twinmedical.ua</p>
              </div>
            </div>
          </div>
        </div>
